...
object Losers {
    ...
    fun init() {
        ...
        Sets.addSet(Sets.TourneySet("Losers", player1, player1Wins, player2, player2Wins))
        ...
        Sets.addSet(Sets.TourneySet("Losers", player3, player3Wins, player4, player4Wins))
        ...
        Sets.addSet(Sets.TourneySet("Losers", player5, player5Wins, player6, player6Wins))
        ...
        Sets.addSet(Sets.TourneySet("Losers", player7, player7Wins, player8, player8Wins))
    }
